...
public class AssetCategoryCommandController {
    ...
    public ResponseEntity<CategoryResponseDTO> createCategory(@Valid @RequestBody CategoryRequestDTO request) {
        return ResultMapper.created(commandService.createCategory(request));
    }
    ...
    public ResponseEntity<CategoryResponseDTO> updateCategory(@PathVariable UUID id, @Valid @RequestBody CategoryRequestDTO request) {
        return ResultMapper.ok(commandService.updateCategory(id, request));
    }
    ...
    public ResponseEntity<Void> deleteCategory(@PathVariable UUID id) {
        return ResultMapper.noContent(commandService.deleteCategory(id));
    }
}
